...
public class ShapeErase extends Shape implements Serializable {	
	
	// 점(x1, y1)과 점(x2, y2)를 연결하는 직선
  	private int x1, y1, x2, y2;		
  
  	// Line 생성자
	public ShapeErase(int x1, int y1, int x2, int y2, Color color)
  	{
	...
	// 직선을 그린다.
  	public void draw(Graphics g)
  	{
		...
		// 지우개 사이즈를 설정하여 지울 수 있도록 한다.
		g.fillRect(this.x1,this.y1,15,15);
	}
