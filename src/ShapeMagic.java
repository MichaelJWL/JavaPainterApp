...
//public class ShapeMagic extends Shape {
public class ShapeMagic extends Shape implements Serializable {	
	
	// 점(x1, y1)과 점(x2, y2)를 연결하는 직선
  	private int x1, y1, x2, y2;
		
	
  	private Line2D.Double line, line2, line3;
  
  	// Line 생성자
	public ShapeMagic(int x1, int y1, int x2, int y2, Color color)
  	{
	...
	// 직선을 그린다.
  	public void draw(Graphics g)
  	{
    	...
    	line = new Line2D.Double(x1, y1-15, x2, y2+15); 
    	line2 = new Line2D.Double(x1+10, y1-10, x2-10, y2+10); 
    	line3 = new Line2D.Double(x1-10, y1-10, x2+10, y2+10); 
