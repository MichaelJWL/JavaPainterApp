...
public class DrawLinepoint extends Order {
    ...
    private int i=1;
  	...
  	{while(i==1){
    		...
    		y1 = p.y;
  	i++;}
  	ShapeLinepoint s = new ShapeLinepoint(x1, y1, x1, y1, Layer.getColor());
    ...
    public void mouseRelExe(Point p, Drawing Layer)
    {
  	...
  	{
    		ShapeLinepoint2 line = new ShapeLinepoint2(x1, y1, p.x, p.y, Layer.getColor());
