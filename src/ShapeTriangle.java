...
public class ShapeTriangle extends Shape implements Serializable {	
	...
	// 직선을 그린다.
  	public void draw(Graphics g)
  	{
    	...
    	line = new Line2D.Double(x1-10,y1+10,x2+20,y2+10); 
    	line2 = new Line2D.Double(x1-10, y1+10, x2+5, y2-15); 
    	line3 = new Line2D.Double(x1+5, y1-15, x2+20, y2+10); 
