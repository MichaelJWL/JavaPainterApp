...
public class ShapeLinepoint2 extends Shape implements Serializable {	
	...
	// 점(x1, y1)과 점(x2, y2)를 연결하는 직선
  	...
  	// Linepoint2 생성자
	public ShapeLinepoint2(int x1, int y1, int x2, int y2, Color color)
  	{
