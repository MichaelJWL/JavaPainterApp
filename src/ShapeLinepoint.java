...
public class ShapeLinepoint extends Shape implements Serializable {	
	...
	// 점(x1, y1)과 점(x2, y2)를 연결하는 직선
  	...
  	// Linepoint 생성자
	public ShapeLinepoint(int x1, int y1, int x2, int y2, Color color)
  	{
	...
	// 직선을 그린다.
  	public void draw(Graphics g)
  	{
		...
		if (super.getSelect() == true){	
			...
			g.fillRect(this.x2,this.y1,5,5);
		}
  	}
